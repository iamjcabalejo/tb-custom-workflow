...
- Before `feature-plan`, `project-manager`, `apply-ticket`, or other explore-heavy commands, follow `.codex/skills/graphify-navigation/SKILL.md`. `apply-ticket` defaults to PLAN-only; run `/project-manager` in a new chat for Code.
