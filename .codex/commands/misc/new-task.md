...
**Graphify:** Follow `.codex/rules/graphify.md` phase budget (PLAN/orient = required `query --budget 1500` before explore; write concrete file paths). Do not load the full `/graphify` skill for routine query.
