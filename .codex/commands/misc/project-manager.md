...
Spawn in this order. Pass **plan path** plus **domain sections only** (not the entire plan body, not Linear dumps). Each subagent must follow `.codex/rules/compounding-dev-cycle.md` Code phase.
