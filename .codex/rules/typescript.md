---
description: TypeScript conventions (Ticketboat frontend: ESM, pnpm, Vitest)
globs: "**/*.ts"
alwaysApply: false
---
...
**Context:** Ticketboat frontend uses ESM modules, pnpm, and Vitest. Prefer strict typing; validate runtime data with zod where needed.

*Also applies:* `token-policy.mdc` (answer shape, diffs, tools). This file is language-only; both apply.
